...
public class MessageReference {
    ...
    public static MessageReference COSMETIC_EQUIP_SUCCESS_OVERLAY = cr("command.cosmetic_equip_success_overlay");
    ...
    public static MessageReference COSMETIC_UNEQUIP_SUCCESS_OVERLAY = cr("command.cosmetic_unequip_success_overlay");
